export class nivel3 extends Phaser.Scene{
    ...
    create ()
    {
        ...
        this.platforms.create(1200, 450, 'ground');
        this.platforms.create(1500, 300, 'ground');
        this.platforms.create(1600, 600, 'ground');
        this.platforms.create(2000, 550, 'ground');
        this.platforms.create(2200, 400, 'ground');
        this.platforms.create(2400, 550, 'ground');
        this.platforms.create(2800, 500, 'ground');
        this.platforms.create(3000, 350, 'ground');
        this.platforms.create(3300, 150, 'ground');
